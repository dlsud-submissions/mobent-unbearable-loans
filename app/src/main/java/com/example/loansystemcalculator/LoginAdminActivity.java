...
public class LoginAdminActivity extends AppCompatActivity {
    ...
    // Admin ID mascot images (0-20+ characters, changes every 3 characters)
    ...
    private void initializeViews() {
        ...
        // Initialize mascot image
        mascotImage = findViewById(R.id.mascotImage);
    }

    private void setupMascotAnimation() {
        // Admin ID text watcher
        etAdminId.addTextChangedListener(new TextWatcher() {
            @Override
        ...
        // Admin ID focus listener
        etAdminId.setOnFocusChangeListener((v, hasFocus) -> {
            if (hasFocus) {
                isPasswordFocused = false;
                updateMascotImage(etAdminId.getText().length(), false);
